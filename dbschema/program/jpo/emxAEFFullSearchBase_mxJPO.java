...
public class emxAEFFullSearchBase_mxJPO {
    ...
    protected JSONObject buildJsonForError(Throwable e, String languageStr) throws Exception {
        ...
        if (isMalformedTextSearchError(e, msgBuf, languageStr)) {
            ...
            return new JSONObject();//UISearchUtil.buildJsonForException(e);//seeta
        }
    }
...
//  System.out.println("BUMMER");
     ...
     * @param args    contains a packed HashMap with the following entries: field -
     ...
     *
     * @param context the eMatrix <code>Context</code> object.
     * @param args    contains a packed HashMap of request parameters
     * @throws Exception if the operation fails.
     * @since AEF 10.7.3
     */
    @com.matrixone.apps.framework.ui.ProgramCallable
     ...
     *
     * @param HashMap the type taxonomky details
     * @param args    contains a packed HashMap of request parameters
     ...
     *
     * @param args contains a packed HashMap with the following entries: filters:
...
// Bug 351815 filters = com.matrixone.apps.domain.util.XSSUtil.decodeFromURL(filters);
     ...
     *
     * @param JSONObject contains a packed filters objects that will come from
     *                   emxUIFullSearch.js
     * @param attribute  contains config field name
     * @param value      contains the value that user selects from the navigation/form
     *                   refinement
     * @param dataType   contains the type of field configured in config.xml
     * @param isUOM      specifies the UOM attribute or not
     * @throws Exception if the operation fails.
     * @since AEF 10.7.3
     */
     ...
     *
     * @param txtType contains TYPES value of field parameter
     * @param type    contains type name that user selects
     * @throws Exception if the operation fails.
     * @since AEF 10.7.3
     */
     ...
     *
     * @param context        the eMatrix <code>Context</code> object.
     * @param allFieldCounts contains HashMap of attibutes
     * @param type           contains packed HashMap of request parameters
     * @throws Exception if the operation fails.
     * @since AEF 10.7.3
     */
...
//      return new Locale(languageStr);
     ...
     *
     * @param context the eMatrix <code>Context</code> object.
     * @param args    contains the packed HashMap of request paremeters
     * @throws Exception if the operation fails.
     * @since AEF 10.7.3
     */
        ...
        if (params.get("parentTaxonomy") != null) {
            ...
            while (enuField.hasMoreElements()) {
                ...
                if (UISearchUtil.FIELD_TYPES.equalsIgnoreCase(field) || UISearchUtil.FIELD_TYPE.equalsIgnoreCase(field)) {
                    ...
                    TaxonomyRefinement refinement = new TaxonomyRefinement(UISearchUtil.FIELD_TYPES, csl, bEqualsOpr);
                    refinementList.add(refinement);
                } else if (UISearchUtil.FIELD_REVISION.equalsIgnoreCase(field)) {
    ...
    protected String getIncludeList(Context context, HashMap params) throws Exception {
        ...
        if (includeOIDprogram != null && !"".equals(includeOIDprogram) && !"null".equals(includeOIDprogram)) {
            ...
            if (inOidProg.length() > 0 && inOidFunc.length() > 0) {
                StringList oidList = (StringList) JPO.invoke(context, inOidProg, new String[]{}, inOidFunc, JPO.packArgs(params),
                        StringList.class);
