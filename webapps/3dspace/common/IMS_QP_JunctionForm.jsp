...
<script>
    function junction(taskId) {
        let select = document.querySelector("#calc_select_document > td.field > select");
        let value = select.options[select.selectedIndex].value;

        let xhr = new XMLHttpRequest();
        xhr.open('GET', 'IMS_QP_JunctionAction.jsp?objectId=' + taskId + '&docId=' + value);
        xhr.send();
