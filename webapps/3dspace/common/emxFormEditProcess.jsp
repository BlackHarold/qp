    ...
    if (objNode) {
        ...
        try {
            if (getTopWindow().getWindowOpener()) {
                ...
                if ((getTopWindow().getWindowOpener().document.location.href.indexOf("emxIndentedTable.jsp") > -1) || (getTopWindow().getWindowOpener().document.location.href.indexOf("ENXSBGridConnectorClient.html") > -1)) {
