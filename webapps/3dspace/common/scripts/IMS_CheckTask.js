...
function IMS_CheckTask(program, programFunction, fromId, toId, relationship, linkId, spinnerId, onDisconnected) {
    console.log("IMS_CheckTask function");

    $("#" + linkId).css("display", "none");
    $("#" + spinnerId).css("display", "");
    // $.get("IMS_KDD_Disconnect.jsp?program=" + program + "&function=" + programFunction + "&fromId=" + fromId + "&toId=" + toId + "&relationship=" + relationship, function(data, status) {
    console.log("prgram: " + program + " function: " + programFunction);
    $.get("IMS_CheckTask.jsp?program=" + program + "&function=" + programFunction + "&fromId=" + fromId + "&toId=" + toId + "&relationship=" + relationship,
