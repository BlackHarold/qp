    ...
    try {
        ...
        if (!"".equalsIgnoreCase(strUIType) && (strUIType != null)) {
            if ("structureBrowser".equalsIgnoreCase(strUIType)) {
                ...
                /**
                 * always put empty MapList into nmpAvailableColumns for custom table view menu
                 * by issue #51293 par.4
                 */
                hmpAvailableColumns.put("currenTableAttributeList", new MapList());
...
<form name="customtable" id='customtable' action="emxCustomizeTableProcess.jsp" method="post">
    <input type="hidden" name="table"
           value='<xss:encodeForHTMLAttribute><%=strCurrentTable%></xss:encodeForHTMLAttribute>'/>
    <input type="hidden" name="uiType" value='<xss:encodeForHTMLAttribute><%=strUIType%></xss:encodeForHTMLAttribute>'/>
    <input type="hidden" name="timeStamp"
           value='<xss:encodeForHTMLAttribute><%=timeStamp%></xss:encodeForHTMLAttribute>'/>
    ...
    <input type="hidden" name="multiColumnSort"
           value='<xss:encodeForHTMLAttribute><%=strMultiColumnSort%></xss:encodeForHTMLAttribute>'/>
    ...
    <table name="Table3" id="Table3" width="100%" height="5%" cellspacing="2" cellpadding="5%">
        <tr>
            <td width="30%" class="label" colspan="1%"><%=strNameLabel%>
            </td>
            <td width="70%" class="inputField" colspan="1%">
                <input name="txtCustomTextBox" id="txtCustomTextBox" size="40%" maxlength=60
                       value='<%=XSSUtil.encodeForHTMLAttribute(context, strTableName)%>'
                       onKeypress="javascript:submitFunction(event)"/>
            </td>
        </tr>
    ...
    <table name="Table1" id="Table1" height="6%" width="100%" cellspacing="0" cellpadding="5%">
        <tr>
            <td class="label" colspan="1%" width="320" nowrap="nowrap"><%=strAvailableColumnsLabel%>
            </td>
            <td class="label" colspan="1%" align="left" width="100%" nowrap="nowrap"><%=strVisibleColumnsLabel%>
            </td>
                    ...
                    <tr>
                        <td class="inputField" width="270px;" valign="top">
                            <select name="AvailableColumn" id="AvailableColumn" size="25" style="width:270px;" multiple>
                                ...
                                %>
                                <option title='<xss:encodeForHTML><%=strColumnText%></xss:encodeForHTML>'
                                        value='<%=strColumnName+"|"+strColumnExpr+"|"+label+"|"+strSortable+"~"+iWidth%>'>
                                    <xss:encodeForHTML><%=strColumnText%>
                                    </xss:encodeForHTML></option>
                                <% }
                                }
                                ...
                                %>
                                <option title='<xss:encodeForHTML><%=strColumnLabel%></xss:encodeForHTML>'
                                        value='<%=strColumnName+"|"+strColumnExpr+"|"+label+"|"+strSortable+"~"+iWidth%>'>
                                    <xss:encodeForHTML><%=strColumnLabel%>
                                    </xss:encodeForHTML></option>
                                <%
                                        }
                                    }
                                ...
                                %>
                                <option value='<%= "Separator|Separator||"+"null~0"%>'>
                                    <xss:encodeForHTML><%= strColumnText%>
                                    </xss:encodeForHTML></option>
                                <%
                                ...
                                %>
                                <option title='<xss:encodeForHTML><%=strColumnLabel%></xss:encodeForHTML>'
                                        value='<%=strColumnName+"|"+strColumnText+"|"+label+"|"+strSortable+"~"+iWidth%>'>
                                    <xss:encodeForHTML><%=strColumnLabel%>
                                    </xss:encodeForHTML></option>
                                <%
                                        }
                        ...
                        <td class="inputField" valign="top" width="80">
                            <table id="Table2" name="Table2" align="center" width="100%">
                                <tr>
                                    <td class="inputField" align="center"><a href="javascript:moveRight()"> <img
                                            id="Rightmove" border="0" src="images/buttonRight.gif"/></a></td>
                                </tr>
                                <tr>
                                    <td class="inputField" align="center"><a href="JavaScript:moveLeft()"> <img
                                            id="Leftmove" border="0" src="images/buttonLeft.gif"/> </a></td>
                                </tr>
                                <tr>
                                    <td class="inputField" align="center"><a href="JavaScript:remove()"> <img
                                            id="Remove" border="0" src="images/buttonRemove.gif"/> </a></td>
                                </tr>
                            </table>
                        </td>
                        <td class="inputField" valign="top" width="320">
                            <table>
                                <tr>
                                    ...
                                    ">
                                    <select name="VisibleColumn" id="VisibleColumn" size="13" style="WIDTH: 270px;"
                                            multiple onclick="displayWidth()" onchange="displayWidth()">
                                        <%
                                        ...
                                        %>
                                        <option title='<xss:encodeForHTML><%=strColumnText%></xss:encodeForHTML>'
                                                value="paneSeparator@SB|paneSeparator|freezePane|false~0">
                                            <xss:encodeForHTML><%=strColumnText %>
                                            </xss:encodeForHTML></option>
                                        <%
                                            }
                                    ...
                                    <td valign="top">
                                        <table align="center">
                                            <tr>
                                                <td class="inputField" valign="top"><a href="JavaScript:moveUp()"> <img
                                                        src="images/buttonArrangeUp.gif" border="0"/> </a></td>
                                            </tr>
                                            <tr>
                                                <td class="inputField" valign="top"><a href="JavaScript:moveDown()">
                                                    <img src="images/buttonArrangeDown.gif" border="0"/> </a></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <table width="100%">
                                <tr id="widthRow">
                                    <td>
                                        <table width="100%">
                                            <tr>
                                                <td class="inputField" align="left" width="72%"><%=strWidthLabel%>
                                                </td>
                                                <td class="inputField" width="30%"><input type="text" size="3"
                                                                                          name="colWidth" id="colWidth"
                                                                                          maxlength=3 align="center"
                                                                                          onfocus="javascript:validate()"
                                                                                          onchange="javascript:setWidth(this)"
                                                                                          onkeypress="javascript:return validateWidth(event);"
                                                                                          oncontextmenu="return false"
                                                                                          onpaste="return false"
                                                                                          ondrop="return false"/></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="inputField" valign="top" width="100%">
                                        <fieldset style="WIDTH: 100%">
                                            <legend><%=strWidthLegendLabel %>
                                            </legend>
                                            <table name="multiColSort" id="multiColSort" width="100%" cellpadding="2"
                                                   cellspacing="3" align="center">
                                                <tr>
                                                    <td class="inputField">&nbsp;</td>
                                                    <td class="inputField"><img src="images/iconSortAscending.gif"
                                                                                border="0"/></td>
                                                    <td class="inputField"><img src="images/iconSortDescending.gif"
                                                                                border="0"/></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="inputField">
                                                        <select name="firstColumn" id="firstColumn"
                                                                ...
                                                                onchange="javascript:populateSecondOption();javascript:populateThirdOption();populate();conflict()">
                                                        </select>
                                                    </td>
                                                    <td class="inputField"><input type="radio" name="firstSortDirection"
                                                                                  value="ascending" checked/></td>
                                                    <td class="inputField"><input type="radio" name="firstSortDirection"
                                                                                  value="descending"/></td>
                                                </tr>
                                                <tr>

                                                    <td class="inputField"><select name="secondColumn" id="secondColumn"
                                                                                   style="max-width: 270px;"
                                                                                   onchange="javascript:populateThirdOption();populate();conflict()">
                                                    </select></td>
                                                    <td class="inputField"><input type="radio"
                                                                                  name="secondSortDirection"
                                                                                  value="ascending" checked/></td>
                                                    <td class="inputField"><input type="radio"
                                                                                  name="secondSortDirection"
                                                                                  value="descending"/></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="inputField"><select name="thirdColumn" id="thirdColumn"
                                                                                   style="max-width: 270px;"
                                                                                   onchange="javascript:populate();conflict()">
                                                    </select></td>
                                                    <td class="inputField"><input type="radio" name="thirdSortDirection"
                                                                                  value="ascending" checked/></td>
                                                    <td class="inputField"><input type="radio" name="thirdSortDirection"
                                                                                  value="descending"/></td>
                                                </tr>
